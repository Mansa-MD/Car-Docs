						...
						<section className="m-t-lg-30 m-t-xs-0">
								...
								<div className="row">
											...
											<div className="image-zoom row m-t-lg-5 m-l-lg-ab-5 m-r-lg-ab-5">
												...
												<div className="col-sm-3 col-md-3 col-lg-3 p-lg-5">
													<a href="images/b-img-2.jpg">
														<img src="../images/b-img-55.jpg" alt=""/>
													</a>
												</div>
												<div className="col-sm-3 col-md-3 col-lg-3 p-lg-5">
													<a href="images/b-img-1.jpg">
														<img src="../images/b-img-56.jpg" alt=""/>
													</a>
												</div>
												<div className="col-sm-3 col-md-3 col-lg-3 p-lg-5">
													<a href="images/b-img-5.jpg">
														<img src="../images/b-img-57.jpg" alt=""/>
													</a>
												</div>
												<div className="col-sm-3 col-md-3 col-lg-3 p-lg-5">
													<a href="images/b-img-10.jpg">
														<img src="../images/b-img-58.jpg" alt=""/>
													</a>
												</div>
											</div>
										</div>
									...
									<div className="col-md-5 col-lg-4">
										<ul className="product_para-1 p-lg-15 bg-gray-f5 bg1-gray-15">
											...
											<li><span>Model :</span>M5</li>
											<li><span>Body :</span>Sedan</li>
											<li><span>Fuel :</span>Mileage</li>
											<li><span>Engine :</span>V8 4.4L Turbo</li>
											<li><span>Transmision :</span>Automatic</li>
											<li><span>Color :</span>Gray</li>
											<li><span>Door :</span>5</li>
											<li><span>Mileage :</span>35139</li>
											<li><span>Warranty :</span>5 years</li>
										</ul>
									</div>
								</div>
							</div>
							<div className="row m-t-lg-30 m-b-lg-50">
								<div className="col-md-8">
									<div className="m-b-lg-30">
										<div className="heading-1"><h3>Overview</h3></div>
											...
											The 2015 BMW M5 is the high-performance variant of the 5 Series sedan and comes equipped with a twin-turbocharged 4.4-liter V-8 with 560 hp (575 hp with the Competition Package) and 500 lb-ft of torque paired to a six-speed manual or a seven-speed dual-clutch automatic transmission. Fuel economy isn't a strong point at 15/22 mpg city/highway with the manual and 14/20 mpg with the automatic.</p>
										</div>
									</div>
									<div className="m-b-lg-30">
									...
									<div className="m-b-lg-0">
										...
										<div className="bg-gray-fa bg1-gray-2 p-lg-30 p-xs-15">
											...
											<ul className="product_para-1">
												<li><span>Layout / number of cylinders :</span>8</li>
												<li><span>Displacement :</span>N/A</li>
												<li><span>Engine Layout :</span>N/A</li>
												<li><span>Horespower :</span>560</li>
												<li><span>@ rpm :</span>6000</li>
												<li><span>Torque :</span>500 lb-ft</li>
												<li><span>Compression ratio :</span>N/A</li>
											</ul>
											<div className="heading-1 m-t-lg-20"><h3 className="f-18">Performance</h3></div>
											<ul className="product_para-1">
												<li><span>Top Track Speed :</span>200</li>
												<li><span>0 - 60 mph :</span>N/A</li>
											</ul>
											<div className="heading-1 m-t-lg-20"><h3 className="f-18">Transmission</h3></div>
											<ul className="product_para-1">
												<li><span>Manual Gearbox :</span>6-speed</li>
											</ul>
											<div className="heading-1 m-t-lg-20"><h3 className="f-18">Fuel consumption</h3></div>
											<ul className="product_para-1">
												<li><span>City (estimate) :</span>15mpg</li>
												<li><span>Highway (estimate) :</span>22mpg</li>
											</ul>
											<div className="heading-1 m-t-lg-20"><h3 className="f-18">Body</h3></div>
											<ul className="product_para-1">
												<li><span>Length :</span>N/A</li>
												<li><span>Width :</span>N/A</li>
												<li><span>Height :</span>N/A</li>
												<li><span>Wheelbase :</span>N/A</li>
												<li><span>Maximum payload :</span>N/A</li>
											</ul>
										</div>
									</div>
								</div>
								<div className="col-sm-12 col-md-4 col-lg-4">
									...
									<h4 className="p-t-lg-0"><a href="">Car Docs</a></h4>
									<div className="clearfix"></div>
									<ul className="list-default m-t-lg-0">
										<li><i className="fa fa-user-circle-o m-r-lg-10  icon"></i>Mr. Doumbia</li>
										<li><i className="fa fa-phone m-r-lg-10 icon"></i>800-Car-Docs</li>
										<li><i className="fa fa-envelope-o m-r-lg-10 icon"></i>Sale@cardealer.com</li>
										<li><i className="fa fa-home m-r-lg-10 icon"></i> New York, USA</li>
