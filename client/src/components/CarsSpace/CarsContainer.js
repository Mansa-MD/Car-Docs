...
class CarsContainer extends Component {
    ...
    viewAllCars(){
        ...
        this.setState({priceRange: '$5,000 - $130,000'});
                ...
                <div className="row">
                    <div className="col-sm-5 col-md-4 col-lg-3">
                            ...
                            <div className="select-wrapper m-b-lg-15">
                                <div className="dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="dropdownMenu3">
                                        ...
                                        <li id="audi" onClick={this.setCarMake}>Audi</li>
                                        <li id="bmw" onClick={this.setCarMake}>BMW</li>
                                        <li id="mercedes" onClick={this.setCarMake}>Mercedes Benz</li>
                                        <li id="mercedes" onClick={this.setCarMake}>Porsche</li>
                                        <li id="all" onClick={this.setCarMake}>All</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="select-wrapper m-b-lg-15">
                                <div className="dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="dropdownMenu5">
                                        ...
                                        <li id="2015" onClick={this.setCarYear}>2018</li>
                                        <li id="2014" onClick={this.setCarYear}>2017</li>
                                        <li id="2013" onClick={this.setCarYear}>2016</li>
                                        <li id="2012" onClick={this.setCarYear}>2015</li>
                                    </ul>
                                </div>
                            </div>
                            <div className="select-wrapper m-b-lg-15">
                        ...
                        <div className="banner-item banner-bg-4 banner-1x color-inher">
                            ...
                            <a href="https://tirerack.com" target="_blank" className="ht-btn ht-btn-default">Shop now</a>
                        </div>
                    </div>
